            ...
            <div className="container flex h-screen w-screen flex-col items-center justify-center">
                ...
                <div className="flex flex-col min-h-screen items-center justify-center gap-6 mx-auto sm:w-[350px]">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <Link href={"https://mytwoney.auth.ca-central-1.amazoncognito.com/oauth2/authorize?identity_provider=Google&redirect_uri=https://mytwoney.com/callback&response_type=CODE&client_id=1rmnfeafn5sk4m50lp8d7a4uc0&scope=email openid phone"}>
